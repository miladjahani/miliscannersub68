...
const navItems = [
  ...
  { to: '/misub/optimizer', label: 'MiSub: بهینه‌ساز', icon: Zap },
  { to: '/misub/scanner', label: 'MiSub: اسکنر IP', icon: Radar },
  { to: '/misub/subscriptions', label: 'MiSub: سابسکریپشن', icon: ListTree },
  { to: '/misub/tools', label: 'MiSub: ابزارها', icon: Wrench },
  { to: '/misub/settings', label: 'MiSub: تنظیمات', icon: SlidersHorizontal },
